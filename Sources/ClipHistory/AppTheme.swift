...
enum AppTheme {
    ...
    // Bottom-tray card dimensions — starting points, tuned live.
    ...
    static let cardPreview   = Font.system(.body).weight(.regular)   // tray card preview text
    ...
    static let hintLabel     = Font.system(.subheadline).weight(.regular)
